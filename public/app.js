Warning: truncated output (original token count: 26655)
Total output lines: 2542
...
…11655 tokens truncated…title: { display: true, text: '销量增长量', color: '#9ca3af' }, ticks: { color: '#9ca3af' }, grid: { color: 'rgba(255,255,255,0.05)' } }
        }
      }
    });
